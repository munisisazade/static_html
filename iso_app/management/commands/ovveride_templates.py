...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/iso_app/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/iso_app/templates && cd iso_app/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
