"""
Django settings for ismayil project.
...
SECRET_KEY = ")z134db7omb4s2tdowd@ws4n@b@w%8qyy76mkuj^x-l^l*6-d#"
...
MIDDLEWARE = [
    ...
    'ismayil.middleware.force_default_middleware.force_default_language_middleware',
...
WSGI_APPLICATION = 'ismayil.wsgi.application'
